...
PAGE_PATHS = {
    "dashboard":   "🏠_Tableau_de_Bord.py",
    "nouvelle":    "pages/1_➕_Nouvelle_Demande.py",
    "demandes":    "pages/2_📋_Mes_Demandes.py",
    "attribution": "pages/3_🎯_Attribution.py",
    "import":      "pages/4_📦_Import_Commandes.py",
    "donnees":     "pages/5_📊_Données.py",
    "suivi":       "pages/6_📈_Suivi.py",
}
